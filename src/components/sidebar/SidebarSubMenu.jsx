  ...
  return (
    <>
      <li className="relative px-6 py-3" key={route.name}>
        <button
          className="inline-flex items-center justify-between focus:outline-none w-full text-sm font-semibold dark:text-white text-black transition-colors duration-150 hover:text-emerald-600 dark:hover:text-gray-200"
        ...
        {open && (
          <ul
            className="p-2  overflow-hidden text-sm font-medium text-gray-500 rounded-md dark:text-gray-400 bg-gray-300 dark:bg-[#ffd9fd]"
            aria-label="submenu"
          >
              ...
              <li key={i + 1}>
                {child?.outside ? (
                  <a
                    ...
                    target="_blank"
                    className="flex items-center font-serif py-1 text-sm text-gray-600 hover:text-green cursor-pointer"
                    // activeStyle={{
                    //   color: "#0d9e6d",
                    // }}
                    rel="noreferrer"
                  ...
                  >
                    ...
                    <span className="text-gray-800 hover:text-emerald-600 dark:hover:text-green-800">
                      {t(`${child.name}`)}
                    </span>
                  </NavLink>
                )}
